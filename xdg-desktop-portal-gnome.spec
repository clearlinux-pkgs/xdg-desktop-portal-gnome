...
Source0  : https://gitlab.gnome.org/GNOME/xdg-desktop-portal-gnome/-/archive/47.1/xdg-desktop-portal-gnome-47.1.tar.gz
...
%prep
%setup -q -n xdg-desktop-portal-gnome-47.1
cd %{_builddir}/xdg-desktop-portal-gnome-47.1
pushd ..
cp -a xdg-desktop-portal-gnome-47.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726846670
